...
//type Props = {};
 class ManualConnection extends Component {
   ...
   stopUsbListener = async () => {
     ...
     const isOpen = await RNSerialport.isOpen(this.state.selectedDevice.name);
     if (isOpen) {
       Alert.alert("isOpen", isOpen);
       //RNSerialport.disconnect();
       RNSerialport.disconnectDevice(this.state.selectedDevice.name);
     }
     //-!-  ToDo-cbs-doc : #TODO revisar que hace eso que sigue  [Besmit-27092021]
   ...
   handleSendButton() {
    ...
    RNSerialport.writeString(this.state.selectedDevice.name, this.state.sendText);
  }
   handleClearButton() {
